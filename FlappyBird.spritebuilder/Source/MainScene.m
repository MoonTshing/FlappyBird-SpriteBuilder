...
@implementation MainScene {
    CGPoint _cloudParallexRatio;
    CGPoint _bushParallexRatio;
    
    CCNode *_parallexContainer;
    CCParallaxNode *_parallexBackground;
...
- (void)didLoadFromCCB {
    ...
    _parallexBackground = [CCParallaxNode node];
    [_parallexContainer addChild:_parallexBackground];
    
    _bushParallexRatio = ccp(0.9,1);
    _cloudParallexRatio = ccp(0.5,1);
    
    for(CCNode *bush in _bushes)
    {
        CGPoint offset = bush.position;
        [self removeChild:bush];
        [_parallexBackground addChild:bush z:0 parallaxRatio:_bushParallexRatio positionOffset:offset];
    ...
    for(CCNode *cloud in _clouds)
    {
        ...
        [_parallexBackground addChild:cloud z:0 parallaxRatio:_cloudParallexRatio positionOffset:offset];
    }
...
- (void)update:(CCTime)delta
{
   ...
   /* //move and loop the bushes
    for( CCNode *bush in _bushes)
    {
        ...
        //if the left conrner is noe complete width off the screen,
